...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__11467 = cljs.core.instance_QMARK_;
var expr__11468 = reactive_val;
if(cljs.core.truth_((pred__11467.cljs$core$IFn$_invoke$arity$2 ? pred__11467.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__11468) : pred__11467.call(null,reagent.ratom.RAtom,expr__11468)))){
return "ra";
} else {
if(cljs.core.truth_((pred__11467.cljs$core$IFn$_invoke$arity$2 ? pred__11467.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__11468) : pred__11467.call(null,reagent.ratom.RCursor,expr__11468)))){
return "rc";
} else {
if(cljs.core.truth_((pred__11467.cljs$core$IFn$_invoke$arity$2 ? pred__11467.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__11468) : pred__11467.call(null,reagent.ratom.Reaction,expr__11468)))){
return "rx";
} else {
if(cljs.core.truth_((pred__11467.cljs$core$IFn$_invoke$arity$2 ? pred__11467.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__11468) : pred__11467.call(null,reagent.ratom.Track,expr__11468)))){
return "tr";
} else {
return "other";
}
