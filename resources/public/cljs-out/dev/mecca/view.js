...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$h3,"Header:"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$table$tg,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$tbody,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$tr,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$th$tg_DASH_0pky,"Offsets"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$th$tg_DASH_0lax,"Hex"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$th$tg_DASH_0lax,"NESplanation"], null)], null),cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__4324__auto__ = (function mecca$view$header_table_$_iter__12590(s__12591){
return (new cljs.core.LazySeq(null,(function (){
var s__12591__$1 = s__12591;
while(true){
var temp__5457__auto__ = cljs.core.seq(s__12591__$1);
if(temp__5457__auto__){
var s__12591__$2 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_(s__12591__$2)){
var c__4322__auto__ = cljs.core.chunk_first(s__12591__$2);
var size__4323__auto__ = cljs.core.count(c__4322__auto__);
var b__12593 = cljs.core.chunk_buffer(size__4323__auto__);
if((function (){var i__12592 = (0);
while(true){
if((i__12592 < size__4323__auto__)){
var vec__12594 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4322__auto__,i__12592);
var vec__12597 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12594,(0),null);
var from = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12597,(0),null);
var to = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12597,(1),null);
var string = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12594,(1),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12594,(2),null);
cljs.core.chunk_append(b__12593,cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$tr,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$td$tg_DASH_hmp3,["$",cljs.core.str.cljs$core$IFn$_invoke$arity$1(from.toString((16)))," - $",cljs.core.str.cljs$core$IFn$_invoke$arity$1(to.toString((16)))].join('')], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$td$tg_DASH_hmp3,cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.interpose.cljs$core$IFn$_invoke$arity$2(" ",mecca.roms.hex_bytes.cljs$core$IFn$_invoke$arity$3(file,from,to)))], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$td$tg_DASH_hmp3,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(string),cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__12600 = mecca.roms.hex_bytes.cljs$core$IFn$_invoke$arity$3(file,from,to);
return (value.cljs$core$IFn$_invoke$arity$1 ? value.cljs$core$IFn$_invoke$arity$1(G__12600) : value.call(null,G__12600));
})())].join('')], null)], null),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$key,from], null)));

var G__12608 = (i__12592 + (1));
i__12592 = G__12608;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__12593),mecca$view$header_table_$_iter__12590(cljs.core.chunk_rest(s__12591__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__12593),null);
}
} else {
var vec__12601 = cljs.core.first(s__12591__$2);
var vec__12604 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12601,(0),null);
var from = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12604,(0),null);
var to = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12604,(1),null);
var string = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12601,(1),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12601,(2),null);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$tr,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$td$tg_DASH_hmp3,["$",cljs.core.str.cljs$core$IFn$_invoke$arity$1(from.toString((16)))," - $",cljs.core.str.cljs$core$IFn$_invoke$arity$1(to.toString((16)))].join('')], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$td$tg_DASH_hmp3,cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.interpose.cljs$core$IFn$_invoke$arity$2(" ",mecca.roms.hex_bytes.cljs$core$IFn$_invoke$arity$3(file,from,to)))], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$td$tg_DASH_hmp3,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(string),cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__12607 = mecca.roms.hex_bytes.cljs$core$IFn$_invoke$arity$3(file,from,to);
return (value.cljs$core$IFn$_invoke$arity$1 ? value.cljs$core$IFn$_invoke$arity$1(G__12607) : value.call(null,G__12607));
})())].join('')], null)], null),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$key,from], null)),mecca$view$header_table_$_iter__12590(cljs.core.rest(s__12591__$2)));
}
} else {
return null;
}
...
var bank = (function (){var G__12612 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$bank], null);
...
var G__12613 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$select_DASH_bank,p1__12609_SHARP_.target.value], null);
...
return p1__12610_SHARP_.toString((16));
});})(bank))
...
return (function (p1__12611_SHARP_){
return ((8192) + p1__12611_SHARP_);
});})(bank))
...
var file = (function (){var G__12615 = dom;
var G__12616 = ["files",(0)];
return goog.object.getValueByKeys(G__12615,G__12616);
})();
...
var G__12617 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$file_DASH_upload,(function (){var G__12618 = (new Uint8Array(p1__12614_SHARP_.target.result));
return goog.crypt.byteArrayToHex(G__12618);
})().toUpperCase()], null);
...
var menu_QMARK_ = (function (){var G__12619 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$burger_DASH_menu_QMARK_], null);
...
return (function mecca$view$menu_items_$_iter__12620(s__12621){
return (new cljs.core.LazySeq(null,((function (selected,menu_QMARK_){
return (function (){
var s__12621__$1 = s__12621;
while(true){
var temp__5457__auto__ = cljs.core.seq(s__12621__$1);
if(temp__5457__auto__){
var s__12621__$2 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_(s__12621__$2)){
var c__4322__auto__ = cljs.core.chunk_first(s__12621__$2);
var size__4323__auto__ = cljs.core.count(c__4322__auto__);
var b__12623 = cljs.core.chunk_buffer(size__4323__auto__);
if((function (){var i__12622 = (0);
while(true){
if((i__12622 < size__4323__auto__)){
var choice = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4322__auto__,i__12622);
cljs.core.chunk_append(b__12623,cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$g,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$style,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$cursor,"pointer"], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$rect,cljs.core.PersistentHashMap.fromArrays([cljs.core.cst$kw$y,cljs.core.cst$kw$rx,cljs.core.cst$kw$stroke,cljs.core.cst$kw$on_DASH_mouse_DASH_out,cljs.core.cst$kw$fill,cljs.core.cst$kw$width,cljs.core.cst$kw$on_DASH_click,cljs.core.cst$kw$stroke_DASH_width,cljs.core.cst$kw$on_DASH_mouse_DASH_over,cljs.core.cst$kw$x,cljs.core.cst$kw$visibility,cljs.core.cst$kw$height],[((35) + (choice * (18))),(2),"black",((function (i__12622,choice,c__4322__auto__,size__4323__auto__,b__12623,s__12621__$2,temp__5457__auto__,selected,menu_QMARK_){
return (function (){
return cljs.core.reset_BANG_(selected,null);
});})(i__12622,choice,c__4322__auto__,size__4323__auto__,b__12623,s__12621__$2,temp__5457__auto__,selected,menu_QMARK_))
,((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(choice,cljs.core.deref(selected)))?"lightpink":"lightgray"),(91),((function (i__12622,choice,c__4322__auto__,size__4323__auto__,b__12623,s__12621__$2,temp__5457__auto__,selected,menu_QMARK_){
return (function (){
var G__12624 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$select_DASH_item,choice], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__12624) : re_frame.core.dispatch.call(null,G__12624));
});})(i__12622,choice,c__4322__auto__,size__4323__auto__,b__12623,s__12621__$2,temp__5457__auto__,selected,menu_QMARK_))
,0.5,((function (i__12622,choice,c__4322__auto__,size__4323__auto__,b__12623,s__12621__$2,temp__5457__auto__,selected,menu_QMARK_){
return (function (){
...
return cljs.core.chunk_cons(cljs.core.chunk(b__12623),mecca$view$menu_items_$_iter__12620(cljs.core.chunk_rest(s__12621__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__12623),null);
}
} else {
var choice = cljs.core.first(s__12621__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$g,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$style,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$cursor,"pointer"], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$rect,cljs.core.PersistentHashMap.fromArrays([cljs.core.cst$kw$y,cljs.core.cst$kw$rx,cljs.core.cst$kw$stroke,cljs.core.cst$kw$on_DASH_mouse_DASH_out,cljs.core.cst$kw$fill,cljs.core.cst$kw$width,cljs.core.cst$kw$on_DASH_click,cljs.core.cst$kw$stroke_DASH_width,cljs.core.cst$kw$on_DASH_mouse_DASH_over,cljs.core.cst$kw$x,cljs.core.cst$kw$visibility,cljs.core.cst$kw$height],[((35) + (choice * (18))),(2),"black",((function (choice,s__12621__$2,temp__5457__auto__,selected,menu_QMARK_){
return (function (){
return cljs.core.reset_BANG_(selected,null);
});})(choice,s__12621__$2,temp__5457__auto__,selected,menu_QMARK_))
,((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(choice,cljs.core.deref(selected)))?"lightpink":"lightgray"),(91),((function (choice,s__12621__$2,temp__5457__auto__,selected,menu_QMARK_){
return (function (){
var G__12625 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$select_DASH_item,choice], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__12625) : re_frame.core.dispatch.call(null,G__12625));
});})(choice,s__12621__$2,temp__5457__auto__,selected,menu_QMARK_))
,0.5,((function (choice,s__12621__$2,temp__5457__auto__,selected,menu_QMARK_){
return (function (){
return cljs.core.reset_BANG_(selected,choice);
});})(choice,s__12621__$2,temp__5457__auto__,selected,menu_QMARK_))
,(3),(cljs.core.truth_(cljs.core.deref(menu_QMARK_))?"visible":"hidden"),(16)])], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$text,new cljs.core.PersistentArrayMap(null, 6, [cljs.core.cst$kw$x,(18),cljs.core.cst$kw$y,((48) + (choice * (18))),cljs.core.cst$kw$text_DASH_anchor,"left",cljs.core.cst$kw$font_DASH_size,(14),cljs.core.cst$kw$pointer_DASH_events,"none",cljs.core.cst$kw$visibility,(cljs.core.truth_(cljs.core.deref(menu_QMARK_))?"visible":"hidden")], null),["Choice ",cljs.core.str.cljs$core$IFn$_invoke$arity$1((choice + (1)))].join('')], null)], null),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$key,choice], null)),mecca$view$menu_items_$_iter__12620(cljs.core.rest(s__12621__$2)));
}
} else {
return null;
}
...
var menu_QMARK_ = (function (){var G__12627 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$burger_DASH_menu_QMARK_], null);
...
return (function (){
var G__12628 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$toggle_DASH_menu], null);
...
var file = (function (){var G__12629 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$file_DASH_upload], null);
...
var selected_item = (function (){var G__12630 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$selected_DASH_item], null);
...
return (function (){
return new cljs.core.PersistentVector(null, 10, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$on_DASH_click,(cljs.core.truth_(cljs.core.deref((function (){var G__12631 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$burger_DASH_menu_QMARK_], null);
...
return (function (){
var G__12632 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$hide_DASH_menu], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__12632) : re_frame.core.dispatch.call(null,G__12632));
});})(file,selected_item))
...
return (function (){
var G__12633 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$file_DASH_upload,mecca.examples.mario.mario_hex], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__12633) : re_frame.core.dispatch.call(null,G__12633));
});})(file,selected_item))
