...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__13226_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,p1__13226_SHARP_);
...
var G__13230 = (function (){var G__13231 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,s);
return goog.crypt.hexToByteArray(G__13231);
})();
return goog.crypt.byteArrayToString(G__13230);
});
...
mecca.roms.nes_offsets = new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(3)], null),(function (p1__13232_SHARP_){
return ["Hex to ASCII: ","\"",cljs.core.str.cljs$core$IFn$_invoke$arity$1(mecca.roms.hex__GT_ascii(p1__13232_SHARP_)),"\""].join('');
})], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(4),(5)], null),(function (p1__13233_SHARP_){
...
})], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(5),(6)], null),(function (p1__13234_SHARP_){
return ["CHR ROM size: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(((8) * parseInt(["0x",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.first(p1__13234_SHARP_))].join(''))))," KB (",cljs.core.str.cljs$core$IFn$_invoke$arity$1(parseInt(["0x",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.first(p1__13234_SHARP_))].join('')))," 8K block",cljs.core.str.cljs$core$IFn$_invoke$arity$1(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),parseInt(["0x",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.first(p1__13234_SHARP_))].join(''))))?null:"s")),")"].join('');
})], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(6),(7)], null),(function (p1__13235_SHARP_){
return ["Hex to binary: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(mecca.roms.format_bin(parseInt(cljs.core.first(p1__13235_SHARP_))))," ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),mecca.roms.nth_bit(parseInt(cljs.core.first(p1__13235_SHARP_)),(0))))?"Bit 0 set - This game uses vertical mirroring (horizontal arrangement). ":null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),mecca.roms.nth_bit(parseInt(cljs.core.first(p1__13235_SHARP_)),(1))))?"Bit 1 set - This cartridge contains battery-backed PRG RAM ($6000-7FFF) or other persistent memory. ":null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),mecca.roms.nth_bit(parseInt(cljs.core.first(p1__13235_SHARP_)),(2))))?"Bit 2 set - This game contains a 512-byte trainer at $7000-$71FF (stored before PRG data). ":null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),mecca.roms.nth_bit(parseInt(cljs.core.first(p1__13235_SHARP_)),(3))))?"Bit 3 set - Ignore mirroring control or above mirroring bit; instead provide four-screen VRAM. ":null)),"The lower mapper nybble is: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (bit){
return mecca.roms.nth_bit(parseInt(cljs.core.first(p1__13235_SHARP_)),bit);
}),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [(7),(6),(5),(4)], null))))].join('');
})], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(7),(8)], null),(function (p1__13236_SHARP_){
return ["Hex to binary: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(mecca.roms.format_bin(parseInt(cljs.core.first(p1__13236_SHARP_))))," ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),mecca.roms.nth_bit(parseInt(cljs.core.first(p1__13236_SHARP_)),(0))))?"Bit 0 set - VS Unisystem. ":null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),mecca.roms.nth_bit(parseInt(cljs.core.first(p1__13236_SHARP_)),(1))))?"Bit 1 set - PlayChoice-10 (8KB of Hint Screen data stored after CHR data) ":null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),mecca.roms.nth_bit(parseInt(cljs.core.first(p1__13236_SHARP_)),(2)))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),mecca.roms.nth_bit(parseInt(cljs.core.first(p1__13236_SHARP_)),(3))))))?"Bits 2 and 3 set - flags 8-15 are in NES 2.0 format. ":null)),"The upper mapper nybble is: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (bit){
return mecca.roms.nth_bit(parseInt(cljs.core.first(p1__13236_SHARP_)),bit);
}),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [(7),(6),(5),(4)], null))))].join('');
