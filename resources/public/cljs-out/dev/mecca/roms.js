...
})], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(7),(8)], null),(function (p1__13237_SHARP_){
return ["Hex to binary: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(mecca.roms.format_bin(parseInt(cljs.core.first(p1__13237_SHARP_))))," ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),mecca.roms.nth_bit(parseInt(cljs.core.first(p1__13237_SHARP_)),(0))))?"Bit 0 set - VS Unisystem. ":null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),mecca.roms.nth_bit(parseInt(cljs.core.first(p1__13237_SHARP_)),(1))))?"Bit 1 set - PlayChoice-10 (8KB of Hint Screen data stored after CHR data) ":null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),mecca.roms.nth_bit(parseInt(cljs.core.first(p1__13237_SHARP_)),(2)))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),mecca.roms.nth_bit(parseInt(cljs.core.first(p1__13237_SHARP_)),(3))))))?"Bits 2 and 3 set - flags 8-15 are in NES 2.0 format. ":null)),"The upper mapper nybble is: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (bit){
return mecca.roms.nth_bit(parseInt(cljs.core.first(p1__13237_SHARP_)),bit);
}),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [(7),(6),(5),(4)], null))))].join('');
})], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(8),(9)], null),cljs.core.first], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(9),(10)], null),cljs.core.first], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(10),(11)], null),cljs.core.first], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(11),(15)], null),(function (p1__13238_SHARP_){
return ["Ripped by (or zeros): ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,p1__13238_SHARP_))].join('');
})], null)], null);
mecca.roms.rom_bank = (function mecca$roms$rom_bank(file,n){
var offsets = cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),cljs.core.drop.cljs$core$IFn$_invoke$arity$2(n,cljs.core.iterate((function (p1__13239_SHARP_){
return ((8192) + p1__13239_SHARP_);
}),(0))));
