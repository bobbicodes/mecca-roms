...
var G__19625 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__19625,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__19625;
}
});
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq19627){
var G__19628 = cljs.core.first.call(null,seq19627);
var seq19627__$1 = cljs.core.next.call(null,seq19627);
var G__19629 = cljs.core.first.call(null,seq19627__$1);
var seq19627__$2 = cljs.core.next.call(null,seq19627__$1);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__19628,G__19629,seq19627__$2);
});
...
var file = cljs.core.get.call(null,map__19634__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__19634__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__19634__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__19634,map__19634__$1,file,line,column){
return (function (p1__19633_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__19633_SHARP_));
});})(map__19634,map__19634__$1,file,line,column))
...
var temp__5457__auto___19636 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___19636)){
var message_19637 = temp__5457__auto___19636;
cljs.core.println.call(null,message_19637);
} else {
}
...
var output_dir__$1 = (function (){var G__19640 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__19640),"/"].join('');
} else {
return G__19640;
}
})();
...
var G__19642 = exception.stack;
var G__19642__$1 = (((G__19642 == null))?null:clojure.string.split_lines.call(null,G__19642));
var G__19642__$2 = (((G__19642__$1 == null))?null:cljs.core.get.call(null,G__19642__$1,depth));
if((G__19642__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__19642__$2);
}
} else {
...
var vec__19643 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__19643,(0),null);
var column = cljs.core.nth.call(null,vec__19643,(1),null);
var vec__19646 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__19646,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__19646,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__19646,(2),null);
...
var m__$1 = (function (){var G__19649 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__19653 = (function (){var G__19652 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__19652);
} else {
return G__19652;
}
})();
...
return cljs.core.vary_meta.call(null,G__19654,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e19655){var e = e19655;
var G__19656 = e;
var G__19656__$1 = (((G__19656 instanceof cljs.core.Keyword))?G__19656.fqn:null);
switch (G__19656__$1) {
...
var vec__19658 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__19658,(0),null);
var types = vec__19658;
...
return cljs.core.map.call(null,(function (p__19661){
var vec__19662 = p__19661;
var ns = cljs.core.nth.call(null,vec__19662,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__19662,(1),null);
return ((function (vec__19662,ns,vars__$1){
return (function (){
...
var G__19665 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__19665__$1 = (((G__19665 instanceof cljs.core.Keyword))?G__19665.fqn:null);
switch (G__19665__$1) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__19665,G__19665__$1,env,once_fixtures,each_fixtures,vec__19662,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__19665,G__19665__$1,env,once_fixtures,each_fixtures,vec__19662,ns,vars__$1){
return (function (){
var seq__19666 = cljs.core.seq.call(null,vars__$1);
var chunk__19667 = null;
var count__19668 = (0);
var i__19669 = (0);
while(true){
if((i__19669 < count__19668)){
var v = cljs.core._nth.call(null,chunk__19667,i__19669);
var temp__5457__auto___19671 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___19671)){
var t_19672 = temp__5457__auto___19671;
each_fixture_fn.call(null,((function (seq__19666,chunk__19667,count__19668,i__19669,t_19672,temp__5457__auto___19671,v,each_fixture_fn,G__19665,G__19665__$1,env,once_fixtures,each_fixtures,vec__19662,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_19672)));
});})(seq__19666,chunk__19667,count__19668,i__19669,t_19672,temp__5457__auto___19671,v,each_fixture_fn,G__19665,G__19665__$1,env,once_fixtures,each_fixtures,vec__19662,ns,vars__$1))
);
} else {
}


var G__19673 = seq__19666;
var G__19674 = chunk__19667;
var G__19675 = count__19668;
var G__19676 = (i__19669 + (1));
seq__19666 = G__19673;
chunk__19667 = G__19674;
count__19668 = G__19675;
i__19669 = G__19676;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__19666);
if(temp__5457__auto__){
var seq__19666__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__19666__$1)){
var c__4351__auto__ = cljs.core.chunk_first.call(null,seq__19666__$1);
var G__19677 = cljs.core.chunk_rest.call(null,seq__19666__$1);
var G__19678 = c__4351__auto__;
var G__19679 = cljs.core.count.call(null,c__4351__auto__);
var G__19680 = (0);
seq__19666 = G__19677;
chunk__19667 = G__19678;
count__19668 = G__19679;
i__19669 = G__19680;
continue;
} else {
var v = cljs.core.first.call(null,seq__19666__$1);
var temp__5457__auto___19681__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___19681__$1)){
var t_19682 = temp__5457__auto___19681__$1;
each_fixture_fn.call(null,((function (seq__19666,chunk__19667,count__19668,i__19669,t_19682,temp__5457__auto___19681__$1,v,seq__19666__$1,temp__5457__auto__,each_fixture_fn,G__19665,G__19665__$1,env,once_fixtures,each_fixtures,vec__19662,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_19682)));
});})(seq__19666,chunk__19667,count__19668,i__19669,t_19682,temp__5457__auto___19681__$1,v,seq__19666__$1,temp__5457__auto__,each_fixture_fn,G__19665,G__19665__$1,env,once_fixtures,each_fixtures,vec__19662,ns,vars__$1))
);
} else {
}


var G__19683 = cljs.core.next.call(null,seq__19666__$1);
var G__19684 = null;
var G__19685 = (0);
var G__19686 = (0);
seq__19666 = G__19683;
chunk__19667 = G__19684;
count__19668 = G__19685;
i__19669 = G__19686;
continue;
}
} else {
...
});})(each_fixture_fn,G__19665,G__19665__$1,env,once_fixtures,each_fixtures,vec__19662,ns,vars__$1))
);
});})(each_fixture_fn,G__19665,G__19665__$1,env,once_fixtures,each_fixtures,vec__19662,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__19665__$1)].join('')));

}
})());
});
;})(vec__19662,ns,vars__$1))
