...
var G__18983 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__18983,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__18983;
}
});
...
var len__4531__auto___18988 = arguments.length;
var i__4532__auto___18989 = (0);
while(true){
if((i__4532__auto___18989 < len__4531__auto___18988)){
args__4534__auto__.push((arguments[i__4532__auto___18989]));

var G__18990 = (i__4532__auto___18989 + (1));
i__4532__auto___18989 = G__18990;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq18985){
var G__18986 = cljs.core.first.call(null,seq18985);
var seq18985__$1 = cljs.core.next.call(null,seq18985);
var G__18987 = cljs.core.first.call(null,seq18985__$1);
var seq18985__$2 = cljs.core.next.call(null,seq18985__$1);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__18986,G__18987,seq18985__$2);
});
...
var file = cljs.core.get.call(null,map__18992__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__18992__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__18992__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__18992,map__18992__$1,file,line,column){
return (function (p1__18991_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__18991_SHARP_));
});})(map__18992,map__18992__$1,file,line,column))
...
var temp__5457__auto___18994 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___18994)){
var message_18995 = temp__5457__auto___18994;
cljs.core.println.call(null,message_18995);
} else {
}
...
var temp__5457__auto___18996 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___18996)){
var message_18997 = temp__5457__auto___18996;
cljs.core.println.call(null,message_18997);
} else {
}
...
var output_dir__$1 = (function (){var G__18998 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__18998),"/"].join('');
} else {
return G__18998;
}
})();
...
var G__19000 = exception.stack;
var G__19000__$1 = (((G__19000 == null))?null:clojure.string.split_lines.call(null,G__19000));
var G__19000__$2 = (((G__19000__$1 == null))?null:cljs.core.get.call(null,G__19000__$1,depth));
if((G__19000__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__19000__$2);
}
} else {
...
var vec__19001 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__19001,(0),null);
var column = cljs.core.nth.call(null,vec__19001,(1),null);
var vec__19004 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__19004,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__19004,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__19004,(2),null);
...
var m__$1 = (function (){var G__19007 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__19011 = (function (){var G__19010 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__19010);
} else {
return G__19010;
}
})();
...
return cljs.core.vary_meta.call(null,G__19012,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e19013){var e = e19013;
var G__19014 = e;
var G__19014__$1 = (((G__19014 instanceof cljs.core.Keyword))?G__19014.fqn:null);
switch (G__19014__$1) {
...
var vec__19016 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__19016,(0),null);
var types = vec__19016;
...
return cljs.core.map.call(null,(function (p__19019){
var vec__19020 = p__19019;
var ns = cljs.core.nth.call(null,vec__19020,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__19020,(1),null);
return ((function (vec__19020,ns,vars__$1){
return (function (){
...
var G__19023 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__19023__$1 = (((G__19023 instanceof cljs.core.Keyword))?G__19023.fqn:null);
switch (G__19023__$1) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__19023,G__19023__$1,env,once_fixtures,each_fixtures,vec__19020,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__19023,G__19023__$1,env,once_fixtures,each_fixtures,vec__19020,ns,vars__$1){
return (function (){
var seq__19024 = cljs.core.seq.call(null,vars__$1);
var chunk__19025 = null;
var count__19026 = (0);
var i__19027 = (0);
while(true){
if((i__19027 < count__19026)){
var v = cljs.core._nth.call(null,chunk__19025,i__19027);
var temp__5457__auto___19029 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___19029)){
var t_19030 = temp__5457__auto___19029;
each_fixture_fn.call(null,((function (seq__19024,chunk__19025,count__19026,i__19027,t_19030,temp__5457__auto___19029,v,each_fixture_fn,G__19023,G__19023__$1,env,once_fixtures,each_fixtures,vec__19020,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_19030)));
});})(seq__19024,chunk__19025,count__19026,i__19027,t_19030,temp__5457__auto___19029,v,each_fixture_fn,G__19023,G__19023__$1,env,once_fixtures,each_fixtures,vec__19020,ns,vars__$1))
);
} else {
}


var G__19031 = seq__19024;
var G__19032 = chunk__19025;
var G__19033 = count__19026;
var G__19034 = (i__19027 + (1));
seq__19024 = G__19031;
chunk__19025 = G__19032;
count__19026 = G__19033;
i__19027 = G__19034;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__19024);
if(temp__5457__auto__){
var seq__19024__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__19024__$1)){
var c__4351__auto__ = cljs.core.chunk_first.call(null,seq__19024__$1);
var G__19035 = cljs.core.chunk_rest.call(null,seq__19024__$1);
var G__19036 = c__4351__auto__;
var G__19037 = cljs.core.count.call(null,c__4351__auto__);
var G__19038 = (0);
seq__19024 = G__19035;
chunk__19025 = G__19036;
count__19026 = G__19037;
i__19027 = G__19038;
continue;
} else {
var v = cljs.core.first.call(null,seq__19024__$1);
var temp__5457__auto___19039__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___19039__$1)){
var t_19040 = temp__5457__auto___19039__$1;
each_fixture_fn.call(null,((function (seq__19024,chunk__19025,count__19026,i__19027,t_19040,temp__5457__auto___19039__$1,v,seq__19024__$1,temp__5457__auto__,each_fixture_fn,G__19023,G__19023__$1,env,once_fixtures,each_fixtures,vec__19020,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_19040)));
});})(seq__19024,chunk__19025,count__19026,i__19027,t_19040,temp__5457__auto___19039__$1,v,seq__19024__$1,temp__5457__auto__,each_fixture_fn,G__19023,G__19023__$1,env,once_fixtures,each_fixtures,vec__19020,ns,vars__$1))
);
} else {
}


var G__19041 = cljs.core.next.call(null,seq__19024__$1);
var G__19042 = null;
var G__19043 = (0);
var G__19044 = (0);
seq__19024 = G__19041;
chunk__19025 = G__19042;
count__19026 = G__19043;
i__19027 = G__19044;
continue;
}
} else {
...
});})(each_fixture_fn,G__19023,G__19023__$1,env,once_fixtures,each_fixtures,vec__19020,ns,vars__$1))
);
});})(each_fixture_fn,G__19023,G__19023__$1,env,once_fixtures,each_fixtures,vec__19020,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__19023__$1)].join('')));

}
})());
});
;})(vec__19020,ns,vars__$1))
