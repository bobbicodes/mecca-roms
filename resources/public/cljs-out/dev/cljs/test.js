...
var G__13338 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__13338,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__13338;
}
});
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq13340){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13341,G__13342,seq13340__$2);
});
...
var map__13347 = m;
var map__13347__$1 = ((((!((map__13347 == null)))?(((((map__13347.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__13347.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__13347):map__13347);
...
var column = cljs.core.get.call(null,map__13347__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__13347,map__13347__$1,file,line,column){
return (function (p1__13346_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__13346_SHARP_));
});})(map__13347,map__13347__$1,file,line,column))
...
var temp__5457__auto___13349 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___13349)){
var message_13350 = temp__5457__auto___13349;
cljs.core.println.call(null,message_13350);
} else {
}
...
var temp__5457__auto___13351 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___13351)){
var message_13352 = temp__5457__auto___13351;
cljs.core.println.call(null,message_13352);
} else {
}
...
var output_dir__$1 = (function (){var G__13353 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__13353),"/"].join('');
} else {
return G__13353;
}
})();
...
var G__13355 = exception.stack;
var G__13355__$1 = (((G__13355 == null))?null:clojure.string.split_lines.call(null,G__13355));
var G__13355__$2 = (((G__13355__$1 == null))?null:cljs.core.get.call(null,G__13355__$1,depth));
if((G__13355__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__13355__$2);
}
} else {
...
var vec__13356 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__13356,(0),null);
var column = cljs.core.nth.call(null,vec__13356,(1),null);
var vec__13359 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__13359,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__13359,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__13359,(2),null);
...
var m__$1 = (function (){var G__13362 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
var G__13362__$1 = (((G__13362 instanceof cljs.core.Keyword))?G__13362.fqn:null);
switch (G__13362__$1) {
case "fail":
...
var G__13366 = (function (){var G__13365 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__13365);
} else {
return G__13365;
}
})();
...
return cljs.core.vary_meta.call(null,G__13367,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e13368){var e = e13368;
var G__13369 = e;
var G__13369__$1 = (((G__13369 instanceof cljs.core.Keyword))?G__13369.fqn:null);
switch (G__13369__$1) {
...
var vec__13371 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__13371,(0),null);
var types = vec__13371;
...
return cljs.core.map.call(null,(function (p__13374){
var vec__13375 = p__13374;
var ns = cljs.core.nth.call(null,vec__13375,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__13375,(1),null);
return ((function (vec__13375,ns,vars__$1){
return (function (){
...
var G__13378 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__13378__$1 = (((G__13378 instanceof cljs.core.Keyword))?G__13378.fqn:null);
switch (G__13378__$1) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__13378,G__13378__$1,env,once_fixtures,each_fixtures,vec__13375,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__13378,G__13378__$1,env,once_fixtures,each_fixtures,vec__13375,ns,vars__$1){
return (function (){
var seq__13379 = cljs.core.seq.call(null,vars__$1);
var chunk__13380 = null;
var count__13381 = (0);
var i__13382 = (0);
while(true){
if((i__13382 < count__13381)){
var v = cljs.core._nth.call(null,chunk__13380,i__13382);
var temp__5457__auto___13384 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___13384)){
var t_13385 = temp__5457__auto___13384;
each_fixture_fn.call(null,((function (seq__13379,chunk__13380,count__13381,i__13382,t_13385,temp__5457__auto___13384,v,each_fixture_fn,G__13378,G__13378__$1,env,once_fixtures,each_fixtures,vec__13375,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_13385)));
});})(seq__13379,chunk__13380,count__13381,i__13382,t_13385,temp__5457__auto___13384,v,each_fixture_fn,G__13378,G__13378__$1,env,once_fixtures,each_fixtures,vec__13375,ns,vars__$1))
);
} else {
}


var G__13386 = seq__13379;
var G__13387 = chunk__13380;
var G__13388 = count__13381;
var G__13389 = (i__13382 + (1));
seq__13379 = G__13386;
chunk__13380 = G__13387;
count__13381 = G__13388;
i__13382 = G__13389;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__13379);
if(temp__5457__auto__){
var seq__13379__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__13379__$1)){
var c__4351__auto__ = cljs.core.chunk_first.call(null,seq__13379__$1);
var G__13390 = cljs.core.chunk_rest.call(null,seq__13379__$1);
var G__13391 = c__4351__auto__;
var G__13392 = cljs.core.count.call(null,c__4351__auto__);
var G__13393 = (0);
seq__13379 = G__13390;
chunk__13380 = G__13391;
count__13381 = G__13392;
i__13382 = G__13393;
continue;
} else {
var v = cljs.core.first.call(null,seq__13379__$1);
var temp__5457__auto___13394__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___13394__$1)){
var t_13395 = temp__5457__auto___13394__$1;
each_fixture_fn.call(null,((function (seq__13379,chunk__13380,count__13381,i__13382,t_13395,temp__5457__auto___13394__$1,v,seq__13379__$1,temp__5457__auto__,each_fixture_fn,G__13378,G__13378__$1,env,once_fixtures,each_fixtures,vec__13375,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_13395)));
});})(seq__13379,chunk__13380,count__13381,i__13382,t_13395,temp__5457__auto___13394__$1,v,seq__13379__$1,temp__5457__auto__,each_fixture_fn,G__13378,G__13378__$1,env,once_fixtures,each_fixtures,vec__13375,ns,vars__$1))
);
} else {
}


var G__13396 = cljs.core.next.call(null,seq__13379__$1);
var G__13397 = null;
var G__13398 = (0);
var G__13399 = (0);
seq__13379 = G__13396;
chunk__13380 = G__13397;
count__13381 = G__13398;
i__13382 = G__13399;
continue;
}
} else {
...
});})(each_fixture_fn,G__13378,G__13378__$1,env,once_fixtures,each_fixtures,vec__13375,ns,vars__$1))
);
});})(each_fixture_fn,G__13378,G__13378__$1,env,once_fixtures,each_fixtures,vec__13375,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__13378__$1)].join('')));

}
})());
});
;})(vec__13375,ns,vars__$1))
