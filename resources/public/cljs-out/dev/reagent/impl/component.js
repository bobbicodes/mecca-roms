...
if((i < len)){
var k = (ks[i]);
var G__11085 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__11086 = (i + (1));
m = G__11085;
i = G__11086;
continue;
...
var temp__5459__auto__ = (p["argv"]);
if((temp__5459__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__11087 = (p["children"]);
return (reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1(G__11087) : reagent.impl.component.global$module$react.Children.toArray.call(null,G__11087));
})());
} else {
var v = temp__5459__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && (!(((function (){var G__11089 = c;
var G__11089__$1 = (((G__11089 == null))?null:G__11089.prototype);
if((G__11089__$1 == null)){
return null;
} else {
return (G__11089__$1["reagentRender"]);
}
})() == null))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && (!(((function (){var G__11091 = c;
var G__11091__$1 = (((G__11091 == null))?null:G__11091.prototype);
if((G__11091__$1 == null)){
return null;
} else {
return (G__11091__$1["render"]);
}
})() == null))));
});
...
var G__11093 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__11093) : reagent.impl.component.as_element.call(null,G__11093));
};
...
var _STAR_current_component_STAR_11099 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_11099;
}});
...
return ((function (G__11100,G__11100__$1){
...
var c = this;
var G__11105_11107 = (c["cljsRatom"]);
if((G__11105_11107 == null)){
} else {
reagent.ratom.dispose_BANG_(G__11105_11107);
}
...
var renders_11109 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_11110 = cljs.core.first(cljs.core.vals(renders_11109));
if((cljs.core.count(renders_11109) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_11109))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_11110)){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["Expected something callable, not ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_11110], 0)))].join('')),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__11108 = name;
switch (G__11108) {
case "":
...
var G__11113 = reagent.impl.component.cljsify(body);
return (reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1(G__11113) : reagent.impl.component.global$module$create_react_class.call(null,G__11113));
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__11114 = fiber;
var G__11114__$1 = (((G__11114 == null))?null:(G__11114["type"]));
if((G__11114__$1 == null)){
return null;
} else {
return (G__11114__$1["displayName"]);
}
})();
var parent = (function (){var G__11115 = fiber;
if((G__11115 == null)){
return null;
} else {
return (G__11115["return"]);
}
})();
var path = (function (){var G__11116 = parent;
var G__11116__$1 = (((G__11116 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__11116) : reagent.impl.component.fiber_component_path.call(null,G__11116)));
if((G__11116__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__11116__$1)," > "].join('');
}
})();
...
var temp__5455__auto__ = (function (){var or__3949__auto__ = (function (){var G__11118 = c;
if((G__11118 == null)){
return null;
} else {
return (G__11118["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
return G__11119._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__3949__auto__ = (function (){var G__11121 = c;
if((G__11121 == null)){
return null;
} else {
return (G__11121["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
var or__3949__auto____$1 = (function (){var G__11123 = c;
if((G__11123 == null)){
return null;
} else {
return G__11123._reactInternalInstance;
}
})();
...
var elem = (function (){var or__3949__auto__ = (function (){var G__11125 = instance;
if((G__11125 == null)){
return null;
} else {
return (G__11125["_currentElement"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
var G__11126 = instance;
if((G__11126 == null)){
return null;
} else {
return G__11126._currentElement;
}
}
})();
var name = (function (){var G__11127 = elem;
var G__11127__$1 = (((G__11127 == null))?null:(G__11127["type"]));
if((G__11127__$1 == null)){
return null;
} else {
return (G__11127__$1["displayName"]);
}
})();
var owner = (function (){var or__3949__auto__ = (function (){var G__11129 = elem;
if((G__11129 == null)){
return null;
} else {
return (G__11129["_owner"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
return G__11130._owner;
}
}
})();
var path = (function (){var G__11131 = owner;
var G__11131__$1 = (((G__11131 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__11131) : reagent.impl.component.component_path.call(null,G__11131)));
if((G__11131__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__11131__$1)," > "].join('');
}
})();
var res = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__11132 = c;
var G__11132__$1 = (((G__11132 == null))?null:G__11132.constructor);
if((G__11132__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__11132__$1);
}
}
})();
