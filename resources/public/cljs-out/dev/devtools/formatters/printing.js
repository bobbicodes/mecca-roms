...
var len__4531__auto___20322 = arguments.length;
var i__4532__auto___20323 = (0);
while(true){
if((i__4532__auto___20323 < len__4531__auto___20322)){
args__4534__auto__.push((arguments[i__4532__auto___20323]));

var G__20324 = (i__4532__auto___20323 + (1));
i__4532__auto___20323 = G__20324;
continue;
} else {
}
break;
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq20319){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20320,G__20321,seq20319__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__20325_SHARP_){
return !((cljs.core.meta.call(null,p1__20325_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__20326__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e20330){var _e__19530__auto__ = e20330;
return false;
}})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
}catch (e20332){var _e__19530__auto__ = e20332;
return false;
}}
})())){
...
var _STAR_current_state_STAR_20334 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__20335 = opts;
...
var markup_db = cljs.core.get.call(null,map__20335__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_20334;
}});
...
;
var temp__5455__auto___20339 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___20339)){
var managed_print_level_20340 = temp__5455__auto___20339;
var _STAR_print_level_STAR_20338_20341 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_20340;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_20338_20341,managed_print_level_20340,temp__5455__auto___20339,writer,opts,job_fn){
return (function (p1__20337_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__20337_SHARP_,null);
});})(_STAR_print_level_STAR_20338_20341,managed_print_level_20340,temp__5455__auto___20339,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_20338_20341;
}} else {
job_fn.call(null);
}
