...
var len__4531__auto___20971 = arguments.length;
var i__4532__auto___20972 = (0);
while(true){
if((i__4532__auto___20972 < len__4531__auto___20971)){
args__4534__auto__.push((arguments[i__4532__auto___20972]));

var G__20973 = (i__4532__auto___20972 + (1));
i__4532__auto___20972 = G__20973;
continue;
} else {
}
break;
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq20968){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20969,G__20970,seq20968__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__20974_SHARP_){
return !((cljs.core.meta.call(null,p1__20974_SHARP_) == null));
})))){
...
var map__20975 = opts;
var map__20975__$1 = ((((!((map__20975 == null)))?(((((map__20975.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__20975.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__20975):map__20975);
var markup_db = cljs.core.get.call(null,map__20975__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e20979){var _e__20179__auto__ = e20979;
return false;
}})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
}catch (e20981){var _e__20179__auto__ = e20981;
return false;
}}
})())){
...
var _STAR_current_state_STAR_20983 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__20984 = opts;
var map__20984__$1 = ((((!((map__20984 == null)))?(((((map__20984.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__20984.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__20984):map__20984);
var markup_db = cljs.core.get.call(null,map__20984__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_20983;
}});
...
;
var temp__5455__auto___20988 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___20988)){
var managed_print_level_20989 = temp__5455__auto___20988;
var _STAR_print_level_STAR_20987_20990 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_20989;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_20987_20990,managed_print_level_20989,temp__5455__auto___20988,writer,opts,job_fn){
return (function (p1__20986_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__20986_SHARP_,null);
});})(_STAR_print_level_STAR_20987_20990,managed_print_level_20989,temp__5455__auto___20988,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_20987_20990;
}} else {
job_fn.call(null);
}
