...
var len__4531__auto___20972 = arguments.length;
var i__4532__auto___20973 = (0);
while(true){
if((i__4532__auto___20973 < len__4531__auto___20972)){
args__4534__auto__.push((arguments[i__4532__auto___20973]));

var G__20974 = (i__4532__auto___20973 + (1));
i__4532__auto___20973 = G__20974;
continue;
} else {
}
break;
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq20969){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20970,G__20971,seq20969__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__20975_SHARP_){
return !((cljs.core.meta.call(null,p1__20975_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__20976__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e20980){var _e__20180__auto__ = e20980;
return false;
}})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
}catch (e20982){var _e__20180__auto__ = e20982;
return false;
}}
})())){
...
var _STAR_current_state_STAR_20984 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__20985 = opts;
...
var markup_db = cljs.core.get.call(null,map__20985__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_20984;
}});
...
;
var temp__5455__auto___20989 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___20989)){
var managed_print_level_20990 = temp__5455__auto___20989;
var _STAR_print_level_STAR_20988_20991 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_20990;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_20988_20991,managed_print_level_20990,temp__5455__auto___20989,writer,opts,job_fn){
return (function (p1__20987_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__20987_SHARP_,null);
});})(_STAR_print_level_STAR_20988_20991,managed_print_level_20990,temp__5455__auto___20989,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_20988_20991;
}} else {
job_fn.call(null);
}
