...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq20310){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20311,G__20312,seq20310__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__20316_SHARP_){
return !((cljs.core.meta.call(null,p1__20316_SHARP_) == null));
})))){
...
var map__20317 = opts;
var map__20317__$1 = ((((!((map__20317 == null)))?(((((map__20317.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__20317.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__20317):map__20317);
var markup_db = cljs.core.get.call(null,map__20317__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e20321){var _e__19521__auto__ = e20321;
return false;
}})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
}catch (e20323){var _e__19521__auto__ = e20323;
return false;
}}
})())){
...
var _STAR_current_state_STAR_20325 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__20326 = opts;
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_20325;
}});
...
;
var temp__5455__auto___20330 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___20330)){
var managed_print_level_20331 = temp__5455__auto___20330;
var _STAR_print_level_STAR_20329_20332 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_20331;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_20329_20332,managed_print_level_20331,temp__5455__auto___20330,writer,opts,job_fn){
return (function (p1__20328_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__20328_SHARP_,null);
});})(_STAR_print_level_STAR_20329_20332,managed_print_level_20331,temp__5455__auto___20330,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_20329_20332;
}} else {
job_fn.call(null);
}
