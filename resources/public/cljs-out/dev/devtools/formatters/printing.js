...
var len__4531__auto___20319 = arguments.length;
var i__4532__auto___20320 = (0);
while(true){
if((i__4532__auto___20320 < len__4531__auto___20319)){
args__4534__auto__.push((arguments[i__4532__auto___20320]));

var G__20321 = (i__4532__auto___20320 + (1));
i__4532__auto___20320 = G__20321;
continue;
} else {
}
break;
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq20316){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20317,G__20318,seq20316__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__20322_SHARP_){
return !((cljs.core.meta.call(null,p1__20322_SHARP_) == null));
})))){
...
var map__20323 = opts;
var map__20323__$1 = ((((!((map__20323 == null)))?(((((map__20323.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__20323.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__20323):map__20323);
var markup_db = cljs.core.get.call(null,map__20323__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e20327){var _e__19527__auto__ = e20327;
return false;
}})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
}catch (e20329){var _e__19527__auto__ = e20329;
return false;
}}
})())){
...
var _STAR_current_state_STAR_20331 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__20332 = opts;
...
var markup_db = cljs.core.get.call(null,map__20332__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_20331;
}});
...
;
var temp__5455__auto___20336 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___20336)){
var managed_print_level_20337 = temp__5455__auto___20336;
var _STAR_print_level_STAR_20335_20338 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_20337;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_20335_20338,managed_print_level_20337,temp__5455__auto___20336,writer,opts,job_fn){
return (function (p1__20334_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__20334_SHARP_,null);
});})(_STAR_print_level_STAR_20335_20338,managed_print_level_20337,temp__5455__auto___20336,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_20335_20338;
}} else {
job_fn.call(null);
}
