...
var len__4531__auto___20296 = arguments.length;
var i__4532__auto___20297 = (0);
while(true){
if((i__4532__auto___20297 < len__4531__auto___20296)){
args__4534__auto__.push((arguments[i__4532__auto___20297]));

var G__20298 = (i__4532__auto___20297 + (1));
i__4532__auto___20297 = G__20298;
continue;
} else {
}
break;
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq20293){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20294,G__20295,seq20293__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__20299_SHARP_){
return !((cljs.core.meta.call(null,p1__20299_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__20300__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e20304){var _e__19504__auto__ = e20304;
return false;
}})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
}catch (e20306){var _e__19504__auto__ = e20306;
return false;
}}
})())){
...
var _STAR_current_state_STAR_20308 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__20309 = opts;
...
var markup_db = cljs.core.get.call(null,map__20309__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_20308;
}});
...
;
var temp__5455__auto___20313 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___20313)){
var managed_print_level_20314 = temp__5455__auto___20313;
var _STAR_print_level_STAR_20312_20315 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_20314;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_20312_20315,managed_print_level_20314,temp__5455__auto___20313,writer,opts,job_fn){
return (function (p1__20311_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__20311_SHARP_,null);
});})(_STAR_print_level_STAR_20312_20315,managed_print_level_20314,temp__5455__auto___20313,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_20312_20315;
}} else {
job_fn.call(null);
}
