...
var G__20706 = devtools.prefs.pref.call(null,v);
v = G__20706;
continue;
} else {
return v;
...
}catch (e20709){var _e__19523__auto__ = e20709;
return false;
}})();
...
}catch (e20713){var _e__19523__auto__ = e20713;
return false;
}})();
...
}catch (e20715){var _e__19523__auto__ = e20715;
return false;
}}
}
});
...
var vec__20717 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__20717,(0),null);
var name = cljs.core.nth.call(null,vec__20717,(1),null);
...
return cljs.core.some.call(null,(function (p1__20720_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__20720_SHARP_);
}),template);
});
