...
var G__20923 = devtools.prefs.pref.call(null,v);
v = G__20923;
continue;
} else {
return v;
...
}catch (e20926){var _e__20177__auto__ = e20926;
return false;
}})();
...
}catch (e20930){var _e__20177__auto__ = e20930;
return false;
}})();
...
}catch (e20932){var _e__20177__auto__ = e20932;
return false;
}}
}
});
...
var vec__20934 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__20934,(0),null);
var name = cljs.core.nth.call(null,vec__20934,(1),null);
...
return cljs.core.some.call(null,(function (p1__20937_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__20937_SHARP_);
}),template);
});
