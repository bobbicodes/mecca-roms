...
var G__20250 = devtools.prefs.pref.call(null,v);
v = G__20250;
continue;
} else {
return v;
...
}catch (e20253){var _e__19504__auto__ = e20253;
return false;
}})();
...
}catch (e20257){var _e__19504__auto__ = e20257;
return false;
}})();
...
}catch (e20259){var _e__19504__auto__ = e20259;
return false;
}}
}
});
...
var vec__20261 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__20261,(0),null);
var name = cljs.core.nth.call(null,vec__20261,(1),null);
...
return cljs.core.some.call(null,(function (p1__20264_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__20264_SHARP_);
}),template);
});
