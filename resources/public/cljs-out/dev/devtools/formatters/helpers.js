...
var G__20927 = devtools.prefs.pref.call(null,v);
v = G__20927;
continue;
} else {
return v;
...
}catch (e20930){var _e__20181__auto__ = e20930;
return false;
}})();
...
}catch (e20934){var _e__20181__auto__ = e20934;
return false;
}})();
...
}catch (e20936){var _e__20181__auto__ = e20936;
return false;
}}
}
});
...
var vec__20938 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__20938,(0),null);
var name = cljs.core.nth.call(null,vec__20938,(1),null);
...
return cljs.core.some.call(null,(function (p1__20941_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__20941_SHARP_);
}),template);
});
