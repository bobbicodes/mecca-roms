...
var o20353 = temp__5455__auto__;
var temp__5455__auto____$1 = (o20353["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o20354 = temp__5455__auto____$1;
return (o20354["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__20173__auto__ = f;
return (o__20173__auto__["toString"]).call(o__20173__auto__);
} else {
return "";
}
}catch (e20355){var _ = e20355;
return "";
}});
...
try{var o__20173__auto___20357 = t;
(o__20173__auto___20357["cljs$lang$ctorPrWriter"]).call(o__20173__auto___20357,t,writer);
}catch (e20356){var __20358 = e20356;
}
...
var char_code = (function (){var o__20173__auto__ = (new String(char$));
return (o__20173__auto__["charCodeAt"]).call(o__20173__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__20173__auto__ = String;
return (o__20173__auto__["fromCharCode"]).call(o__20173__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__20359 = num_code;
switch (G__20359) {
case (1):
return (185);
...
var o__20173__auto__ = String;
return (o__20173__auto__["fromCharCode"]).call(o__20173__auto__,superscript_code);
});
/**
...
}catch (e20361){var _e__20180__auto__ = e20361;
return false;
}})())){
...
var vec__20362 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__20362,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o20365 = temp__5455__auto__;
var temp__5455__auto____$1 = (o20365["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o20366 = temp__5455__auto____$1;
return (o20366["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4531__auto___20373 = arguments.length;
var i__4532__auto___20374 = (0);
while(true){
if((i__4532__auto___20374 < len__4531__auto___20373)){
args__4534__auto__.push((arguments[i__4532__auto___20374]));

var G__20375 = (i__4532__auto___20374 + (1));
i__4532__auto___20374 = G__20375;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__20369){
var vec__20370 = p__20369;
var ns_detector = cljs.core.nth.call(null,vec__20370,(0),null);
...
var G__20376 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__20377 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__20376;
remaining_tokens = G__20377;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq20367){
var G__20368 = cljs.core.first.call(null,seq20367);
var seq20367__$1 = cljs.core.next.call(null,seq20367);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20368,seq20367__$1);
});
...
var vec__20381 = cljs.core.split_with.call(null,(function (p1__20380_SHARP_){
return cljs.core.not_EQ_.call(null,p1__20380_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__20381,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__20381,(1),null);
...
var vec__20384 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__20384,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__20384,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__20387 = cljs.core.rest.call(null,remaining_tokens);
var G__20388 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__20387;
name_tokens = G__20388;
continue;
} else {
...
var vec__20391 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__20391,(0),null);
var arity = cljs.core.nth.call(null,vec__20391,(1),null);
var vec__20394 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__20394,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__20394,(1),null);
var vec__20397 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__20397,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__20397,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__20397,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__20397,(3),null);
...
var vec__20403 = result;
var munged_ns = cljs.core.nth.call(null,vec__20403,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__20403,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__20403,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__20403,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__20403,(4),null);
var arity = cljs.core.nth.call(null,vec__20403,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__20407 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__20407,(0),null);
var args = cljs.core.nth.call(null,vec__20407,(1),null);
var vec__20410 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__20410,(0),null);
var name = cljs.core.nth.call(null,vec__20410,(1),null);
...
var G__20413 = (arity + (1));
var G__20414 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__20415){
var vec__20416 = p__20415;
var arity = cljs.core.nth.call(null,vec__20416,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__20416,(1),null);
...
return cljs.core.get.call(null,arities,p1__20419_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__20420_SHARP_);
...
var args__4534__auto__ = [];
var len__4531__auto___20427 = arguments.length;
var i__4532__auto___20428 = (0);
while(true){
if((i__4532__auto___20428 < len__4531__auto___20427)){
args__4534__auto__.push((arguments[i__4532__auto___20428]));

var G__20429 = (i__4532__auto___20428 + (1));
i__4532__auto___20428 = G__20429;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__20423){
var vec__20424 = p__20423;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__20424,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq20421){
var G__20422 = cljs.core.first.call(null,seq20421);
var seq20421__$1 = cljs.core.next.call(null,seq20421);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20422,seq20421__$1);
});
...
var map__20432 = options;
var map__20432__$1 = ((((!((map__20432 == null)))?(((((map__20432.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__20432.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__20432):map__20432);
var include_ns_QMARK_ = cljs.core.get.call(null,map__20432__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__20432__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__20432__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__20432__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__20433 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__20433,(0),null);
var fn_name = cljs.core.nth.call(null,vec__20433,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__20433,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__20433,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__20433,(4),null);
var arity = cljs.core.nth.call(null,vec__20433,(5),null);
...
var o__20173__auto__ = f;
return (o__20173__auto__["getBasis"]).call(o__20173__auto__);
});
/**
...
}catch (e20437){var _e__20180__auto__ = e20437;
...
var G__20438 = (obj[cljs.core.first.call(null,path)]);
var G__20439 = cljs.core.rest.call(null,path);
obj = G__20438;
path = G__20439;
continue;
} else {
...
return (function (accum,p__20440){
var vec__20441 = p__20440;
var bit = cljs.core.nth.call(null,vec__20441,(0),null);
var protocol = cljs.core.nth.call(null,vec__20441,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__20444){
var vec__20445 = p__20444;
var ns = cljs.core.nth.call(null,vec__20445,(0),null);
var name = cljs.core.nth.call(null,vec__20445,(1),null);
var selector = cljs.core.nth.call(null,vec__20445,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__20450,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__20450,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__20450,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__20448_SHARP_){
return (obj[cljs.core.first.call(null,p1__20448_SHARP_)]);
});})(name,sorted_matches,vec__20450,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
