...
var o19669 = temp__5455__auto__;
var temp__5455__auto____$1 = (o19669["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o19670 = temp__5455__auto____$1;
return (o19670["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__19489__auto__ = f;
return (o__19489__auto__["toString"]).call(o__19489__auto__);
} else {
return "";
}
}catch (e19671){var _ = e19671;
return "";
}});
...
try{var o__19489__auto___19673 = t;
(o__19489__auto___19673["cljs$lang$ctorPrWriter"]).call(o__19489__auto___19673,t,writer);
}catch (e19672){var __19674 = e19672;
}
...
var char_code = (function (){var o__19489__auto__ = (new String(char$));
return (o__19489__auto__["charCodeAt"]).call(o__19489__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__19489__auto__ = String;
return (o__19489__auto__["fromCharCode"]).call(o__19489__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__19675 = num_code;
switch (G__19675) {
case (1):
return (185);
...
var o__19489__auto__ = String;
return (o__19489__auto__["fromCharCode"]).call(o__19489__auto__,superscript_code);
});
/**
...
}catch (e19677){var _e__19496__auto__ = e19677;
return false;
}})())){
...
var vec__19678 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__19678,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o19681 = temp__5455__auto__;
var temp__5455__auto____$1 = (o19681["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o19682 = temp__5455__auto____$1;
return (o19682["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4531__auto___19689 = arguments.length;
var i__4532__auto___19690 = (0);
while(true){
if((i__4532__auto___19690 < len__4531__auto___19689)){
args__4534__auto__.push((arguments[i__4532__auto___19690]));

var G__19691 = (i__4532__auto___19690 + (1));
i__4532__auto___19690 = G__19691;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__19685){
var vec__19686 = p__19685;
var ns_detector = cljs.core.nth.call(null,vec__19686,(0),null);
...
var G__19692 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__19693 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__19692;
remaining_tokens = G__19693;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq19683){
var G__19684 = cljs.core.first.call(null,seq19683);
var seq19683__$1 = cljs.core.next.call(null,seq19683);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__19684,seq19683__$1);
});
...
var vec__19697 = cljs.core.split_with.call(null,(function (p1__19696_SHARP_){
return cljs.core.not_EQ_.call(null,p1__19696_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__19697,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__19697,(1),null);
...
var vec__19700 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__19700,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__19700,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__19703 = cljs.core.rest.call(null,remaining_tokens);
var G__19704 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__19703;
name_tokens = G__19704;
continue;
} else {
...
var vec__19707 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__19707,(0),null);
var arity = cljs.core.nth.call(null,vec__19707,(1),null);
var vec__19710 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__19710,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__19710,(1),null);
var vec__19713 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__19713,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__19713,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__19713,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__19713,(3),null);
...
var vec__19719 = result;
var munged_ns = cljs.core.nth.call(null,vec__19719,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__19719,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__19719,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__19719,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__19719,(4),null);
var arity = cljs.core.nth.call(null,vec__19719,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__19723 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__19723,(0),null);
var args = cljs.core.nth.call(null,vec__19723,(1),null);
var vec__19726 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__19726,(0),null);
var name = cljs.core.nth.call(null,vec__19726,(1),null);
...
var G__19729 = (arity + (1));
var G__19730 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__19731){
var vec__19732 = p__19731;
var arity = cljs.core.nth.call(null,vec__19732,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__19732,(1),null);
...
return cljs.core.get.call(null,arities,p1__19735_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__19736_SHARP_);
...
var args__4534__auto__ = [];
var len__4531__auto___19743 = arguments.length;
var i__4532__auto___19744 = (0);
while(true){
if((i__4532__auto___19744 < len__4531__auto___19743)){
args__4534__auto__.push((arguments[i__4532__auto___19744]));

var G__19745 = (i__4532__auto___19744 + (1));
i__4532__auto___19744 = G__19745;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__19739){
var vec__19740 = p__19739;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__19740,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq19737){
var G__19738 = cljs.core.first.call(null,seq19737);
var seq19737__$1 = cljs.core.next.call(null,seq19737);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__19738,seq19737__$1);
});
...
var G__19746 = arg;
var G__19746__$1 = (((G__19746 instanceof cljs.core.Keyword))?G__19746.fqn:null);
switch (G__19746__$1) {
...
var map__19748 = options;
var map__19748__$1 = ((((!((map__19748 == null)))?(((((map__19748.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__19748.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__19748):map__19748);
var include_ns_QMARK_ = cljs.core.get.call(null,map__19748__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__19748__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__19748__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__19748__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__19749 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__19749,(0),null);
var fn_name = cljs.core.nth.call(null,vec__19749,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__19749,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__19749,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__19749,(4),null);
var arity = cljs.core.nth.call(null,vec__19749,(5),null);
...
var o__19489__auto__ = f;
return (o__19489__auto__["getBasis"]).call(o__19489__auto__);
});
/**
...
}catch (e19753){var _e__19496__auto__ = e19753;
...
var G__19754 = (obj[cljs.core.first.call(null,path)]);
var G__19755 = cljs.core.rest.call(null,path);
obj = G__19754;
path = G__19755;
continue;
} else {
...
return (function (accum,p__19756){
var vec__19757 = p__19756;
var bit = cljs.core.nth.call(null,vec__19757,(0),null);
var protocol = cljs.core.nth.call(null,vec__19757,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__19760){
var vec__19761 = p__19760;
var ns = cljs.core.nth.call(null,vec__19761,(0),null);
var name = cljs.core.nth.call(null,vec__19761,(1),null);
var selector = cljs.core.nth.call(null,vec__19761,(2),null);
...
return (function (p__19765){
var vec__19766 = p__19765;
var munged_name = cljs.core.nth.call(null,vec__19766,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__19766,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__19766,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__19764_SHARP_){
return (obj[cljs.core.first.call(null,p1__19764_SHARP_)]);
});})(name,sorted_matches,vec__19766,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
