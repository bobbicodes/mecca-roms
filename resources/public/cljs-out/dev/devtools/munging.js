...
var o20354 = temp__5455__auto__;
var temp__5455__auto____$1 = (o20354["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o20355 = temp__5455__auto____$1;
return (o20355["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__20174__auto__ = f;
return (o__20174__auto__["toString"]).call(o__20174__auto__);
} else {
return "";
}
}catch (e20356){var _ = e20356;
return "";
}});
...
try{var o__20174__auto___20358 = t;
(o__20174__auto___20358["cljs$lang$ctorPrWriter"]).call(o__20174__auto___20358,t,writer);
}catch (e20357){var __20359 = e20357;
}
...
var char_code = (function (){var o__20174__auto__ = (new String(char$));
return (o__20174__auto__["charCodeAt"]).call(o__20174__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__20174__auto__ = String;
return (o__20174__auto__["fromCharCode"]).call(o__20174__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__20360 = num_code;
switch (G__20360) {
case (1):
return (185);
...
var o__20174__auto__ = String;
return (o__20174__auto__["fromCharCode"]).call(o__20174__auto__,superscript_code);
});
/**
...
}catch (e20362){var _e__20181__auto__ = e20362;
return false;
}})())){
...
var vec__20363 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__20363,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o20366 = temp__5455__auto__;
var temp__5455__auto____$1 = (o20366["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o20367 = temp__5455__auto____$1;
return (o20367["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4531__auto___20374 = arguments.length;
var i__4532__auto___20375 = (0);
while(true){
if((i__4532__auto___20375 < len__4531__auto___20374)){
args__4534__auto__.push((arguments[i__4532__auto___20375]));

var G__20376 = (i__4532__auto___20375 + (1));
i__4532__auto___20375 = G__20376;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__20370){
var vec__20371 = p__20370;
var ns_detector = cljs.core.nth.call(null,vec__20371,(0),null);
...
var G__20377 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__20378 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__20377;
remaining_tokens = G__20378;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq20368){
var G__20369 = cljs.core.first.call(null,seq20368);
var seq20368__$1 = cljs.core.next.call(null,seq20368);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20369,seq20368__$1);
});
...
var vec__20382 = cljs.core.split_with.call(null,(function (p1__20381_SHARP_){
return cljs.core.not_EQ_.call(null,p1__20381_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__20382,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__20382,(1),null);
...
var vec__20385 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__20385,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__20385,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__20388 = cljs.core.rest.call(null,remaining_tokens);
var G__20389 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__20388;
name_tokens = G__20389;
continue;
} else {
...
var vec__20392 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__20392,(0),null);
var arity = cljs.core.nth.call(null,vec__20392,(1),null);
var vec__20395 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__20395,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__20395,(1),null);
var vec__20398 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__20398,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__20398,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__20398,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__20398,(3),null);
...
var vec__20404 = result;
var munged_ns = cljs.core.nth.call(null,vec__20404,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__20404,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__20404,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__20404,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__20404,(4),null);
var arity = cljs.core.nth.call(null,vec__20404,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__20408 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__20408,(0),null);
var args = cljs.core.nth.call(null,vec__20408,(1),null);
var vec__20411 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__20411,(0),null);
var name = cljs.core.nth.call(null,vec__20411,(1),null);
...
var G__20414 = (arity + (1));
var G__20415 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__20416){
var vec__20417 = p__20416;
var arity = cljs.core.nth.call(null,vec__20417,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__20417,(1),null);
...
return cljs.core.get.call(null,arities,p1__20420_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__20421_SHARP_);
...
var args__4534__auto__ = [];
var len__4531__auto___20428 = arguments.length;
var i__4532__auto___20429 = (0);
while(true){
if((i__4532__auto___20429 < len__4531__auto___20428)){
args__4534__auto__.push((arguments[i__4532__auto___20429]));

var G__20430 = (i__4532__auto___20429 + (1));
i__4532__auto___20429 = G__20430;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__20424){
var vec__20425 = p__20424;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__20425,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq20422){
var G__20423 = cljs.core.first.call(null,seq20422);
var seq20422__$1 = cljs.core.next.call(null,seq20422);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20423,seq20422__$1);
});
...
var map__20433 = options;
var map__20433__$1 = ((((!((map__20433 == null)))?(((((map__20433.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__20433.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__20433):map__20433);
var include_ns_QMARK_ = cljs.core.get.call(null,map__20433__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__20433__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__20433__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__20433__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__20434 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__20434,(0),null);
var fn_name = cljs.core.nth.call(null,vec__20434,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__20434,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__20434,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__20434,(4),null);
var arity = cljs.core.nth.call(null,vec__20434,(5),null);
...
var o__20174__auto__ = f;
return (o__20174__auto__["getBasis"]).call(o__20174__auto__);
});
/**
...
}catch (e20438){var _e__20181__auto__ = e20438;
...
var G__20439 = (obj[cljs.core.first.call(null,path)]);
var G__20440 = cljs.core.rest.call(null,path);
obj = G__20439;
path = G__20440;
continue;
} else {
...
return (function (accum,p__20441){
var vec__20442 = p__20441;
var bit = cljs.core.nth.call(null,vec__20442,(0),null);
var protocol = cljs.core.nth.call(null,vec__20442,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__20445){
var vec__20446 = p__20445;
var ns = cljs.core.nth.call(null,vec__20446,(0),null);
var name = cljs.core.nth.call(null,vec__20446,(1),null);
var selector = cljs.core.nth.call(null,vec__20446,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__20451,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__20451,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__20451,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__20449_SHARP_){
return (obj[cljs.core.first.call(null,p1__20449_SHARP_)]);
});})(name,sorted_matches,vec__20451,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
