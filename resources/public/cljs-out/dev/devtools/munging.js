...
var o20586 = temp__5455__auto__;
var temp__5455__auto____$1 = (o20586["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o20587 = temp__5455__auto____$1;
return (o20587["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__19516__auto__ = f;
return (o__19516__auto__["toString"]).call(o__19516__auto__);
} else {
return "";
}
}catch (e20588){var _ = e20588;
return "";
}});
...
try{var o__19516__auto___20590 = t;
(o__19516__auto___20590["cljs$lang$ctorPrWriter"]).call(o__19516__auto___20590,t,writer);
}catch (e20589){var __20591 = e20589;
}
...
var char_code = (function (){var o__19516__auto__ = (new String(char$));
return (o__19516__auto__["charCodeAt"]).call(o__19516__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__19516__auto__ = String;
return (o__19516__auto__["fromCharCode"]).call(o__19516__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__20592 = num_code;
switch (G__20592) {
case (1):
return (185);
...
var o__19516__auto__ = String;
return (o__19516__auto__["fromCharCode"]).call(o__19516__auto__,superscript_code);
});
/**
...
}catch (e20594){var _e__19523__auto__ = e20594;
return false;
}})())){
...
var vec__20595 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__20595,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o20598 = temp__5455__auto__;
var temp__5455__auto____$1 = (o20598["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o20599 = temp__5455__auto____$1;
return (o20599["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__20602){
var vec__20603 = p__20602;
var ns_detector = cljs.core.nth.call(null,vec__20603,(0),null);
...
var G__20609 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__20610 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__20609;
remaining_tokens = G__20610;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq20600){
var G__20601 = cljs.core.first.call(null,seq20600);
var seq20600__$1 = cljs.core.next.call(null,seq20600);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20601,seq20600__$1);
});
...
var vec__20614 = cljs.core.split_with.call(null,(function (p1__20613_SHARP_){
return cljs.core.not_EQ_.call(null,p1__20613_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__20614,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__20614,(1),null);
...
var vec__20617 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__20617,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__20617,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__20620 = cljs.core.rest.call(null,remaining_tokens);
var G__20621 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__20620;
name_tokens = G__20621;
continue;
} else {
...
var vec__20624 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__20624,(0),null);
var arity = cljs.core.nth.call(null,vec__20624,(1),null);
var vec__20627 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__20627,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__20627,(1),null);
var vec__20630 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__20630,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__20630,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__20630,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__20630,(3),null);
...
var vec__20636 = result;
var munged_ns = cljs.core.nth.call(null,vec__20636,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__20636,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__20636,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__20636,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__20636,(4),null);
var arity = cljs.core.nth.call(null,vec__20636,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__20640 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__20640,(0),null);
var args = cljs.core.nth.call(null,vec__20640,(1),null);
var vec__20643 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__20643,(0),null);
var name = cljs.core.nth.call(null,vec__20643,(1),null);
...
var G__20646 = (arity + (1));
var G__20647 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__20648){
var vec__20649 = p__20648;
var arity = cljs.core.nth.call(null,vec__20649,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__20649,(1),null);
...
return cljs.core.get.call(null,arities,p1__20652_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__20653_SHARP_);
...
var args__4534__auto__ = [];
var len__4531__auto___20660 = arguments.length;
var i__4532__auto___20661 = (0);
while(true){
if((i__4532__auto___20661 < len__4531__auto___20660)){
args__4534__auto__.push((arguments[i__4532__auto___20661]));

var G__20662 = (i__4532__auto___20661 + (1));
i__4532__auto___20661 = G__20662;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__20656){
var vec__20657 = p__20656;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__20657,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq20654){
var G__20655 = cljs.core.first.call(null,seq20654);
var seq20654__$1 = cljs.core.next.call(null,seq20654);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20655,seq20654__$1);
});
...
var map__20665 = options;
var map__20665__$1 = ((((!((map__20665 == null)))?(((((map__20665.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__20665.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__20665):map__20665);
var include_ns_QMARK_ = cljs.core.get.call(null,map__20665__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__20665__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__20665__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__20665__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__20666 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__20666,(0),null);
var fn_name = cljs.core.nth.call(null,vec__20666,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__20666,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__20666,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__20666,(4),null);
var arity = cljs.core.nth.call(null,vec__20666,(5),null);
...
var o__19516__auto__ = f;
return (o__19516__auto__["getBasis"]).call(o__19516__auto__);
});
/**
...
}catch (e20670){var _e__19523__auto__ = e20670;
...
var G__20671 = (obj[cljs.core.first.call(null,path)]);
var G__20672 = cljs.core.rest.call(null,path);
obj = G__20671;
path = G__20672;
continue;
} else {
...
return (function (accum,p__20673){
var vec__20674 = p__20673;
var bit = cljs.core.nth.call(null,vec__20674,(0),null);
var protocol = cljs.core.nth.call(null,vec__20674,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__20677){
var vec__20678 = p__20677;
var ns = cljs.core.nth.call(null,vec__20678,(0),null);
var name = cljs.core.nth.call(null,vec__20678,(1),null);
var selector = cljs.core.nth.call(null,vec__20678,(2),null);
...
return (function (p__20682){
var vec__20683 = p__20682;
var munged_name = cljs.core.nth.call(null,vec__20683,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__20683,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__20683,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__20681_SHARP_){
return (obj[cljs.core.first.call(null,p1__20681_SHARP_)]);
});})(name,sorted_matches,vec__20683,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
