...
var o19677 = temp__5455__auto__;
var temp__5455__auto____$1 = (o19677["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o19678 = temp__5455__auto____$1;
return (o19678["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__19497__auto__ = f;
return (o__19497__auto__["toString"]).call(o__19497__auto__);
} else {
return "";
}
}catch (e19679){var _ = e19679;
return "";
}});
...
try{var o__19497__auto___19681 = t;
(o__19497__auto___19681["cljs$lang$ctorPrWriter"]).call(o__19497__auto___19681,t,writer);
}catch (e19680){var __19682 = e19680;
}
...
var char_code = (function (){var o__19497__auto__ = (new String(char$));
return (o__19497__auto__["charCodeAt"]).call(o__19497__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__19497__auto__ = String;
return (o__19497__auto__["fromCharCode"]).call(o__19497__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__19683 = num_code;
switch (G__19683) {
case (1):
return (185);
...
var o__19497__auto__ = String;
return (o__19497__auto__["fromCharCode"]).call(o__19497__auto__,superscript_code);
});
/**
...
}catch (e19685){var _e__19504__auto__ = e19685;
return false;
}})())){
...
var vec__19686 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__19686,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o19689 = temp__5455__auto__;
var temp__5455__auto____$1 = (o19689["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o19690 = temp__5455__auto____$1;
return (o19690["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4531__auto___19697 = arguments.length;
var i__4532__auto___19698 = (0);
while(true){
if((i__4532__auto___19698 < len__4531__auto___19697)){
args__4534__auto__.push((arguments[i__4532__auto___19698]));

var G__19699 = (i__4532__auto___19698 + (1));
i__4532__auto___19698 = G__19699;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__19693){
var vec__19694 = p__19693;
var ns_detector = cljs.core.nth.call(null,vec__19694,(0),null);
...
var G__19700 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__19701 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__19700;
remaining_tokens = G__19701;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq19691){
var G__19692 = cljs.core.first.call(null,seq19691);
var seq19691__$1 = cljs.core.next.call(null,seq19691);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__19692,seq19691__$1);
});
...
var vec__19705 = cljs.core.split_with.call(null,(function (p1__19704_SHARP_){
return cljs.core.not_EQ_.call(null,p1__19704_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__19705,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__19705,(1),null);
...
var vec__19708 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__19708,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__19708,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__19711 = cljs.core.rest.call(null,remaining_tokens);
var G__19712 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__19711;
name_tokens = G__19712;
continue;
} else {
...
var vec__19715 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__19715,(0),null);
var arity = cljs.core.nth.call(null,vec__19715,(1),null);
var vec__19718 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__19718,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__19718,(1),null);
var vec__19721 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__19721,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__19721,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__19721,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__19721,(3),null);
...
var vec__19727 = result;
var munged_ns = cljs.core.nth.call(null,vec__19727,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__19727,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__19727,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__19727,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__19727,(4),null);
var arity = cljs.core.nth.call(null,vec__19727,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__19731 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__19731,(0),null);
var args = cljs.core.nth.call(null,vec__19731,(1),null);
var vec__19734 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__19734,(0),null);
var name = cljs.core.nth.call(null,vec__19734,(1),null);
...
var G__19737 = (arity + (1));
var G__19738 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__19739){
var vec__19740 = p__19739;
var arity = cljs.core.nth.call(null,vec__19740,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__19740,(1),null);
...
return cljs.core.get.call(null,arities,p1__19743_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__19744_SHARP_);
...
var args__4534__auto__ = [];
var len__4531__auto___19751 = arguments.length;
var i__4532__auto___19752 = (0);
while(true){
if((i__4532__auto___19752 < len__4531__auto___19751)){
args__4534__auto__.push((arguments[i__4532__auto___19752]));

var G__19753 = (i__4532__auto___19752 + (1));
i__4532__auto___19752 = G__19753;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__19747){
var vec__19748 = p__19747;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__19748,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq19745){
var G__19746 = cljs.core.first.call(null,seq19745);
var seq19745__$1 = cljs.core.next.call(null,seq19745);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__19746,seq19745__$1);
});
...
var G__19754 = arg;
var G__19754__$1 = (((G__19754 instanceof cljs.core.Keyword))?G__19754.fqn:null);
switch (G__19754__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__19756__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__19756__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__19756__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__19756__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__19757 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__19757,(0),null);
var fn_name = cljs.core.nth.call(null,vec__19757,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__19757,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__19757,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__19757,(4),null);
var arity = cljs.core.nth.call(null,vec__19757,(5),null);
...
var o__19497__auto__ = f;
return (o__19497__auto__["getBasis"]).call(o__19497__auto__);
});
/**
...
}catch (e19761){var _e__19504__auto__ = e19761;
...
var G__19762 = (obj[cljs.core.first.call(null,path)]);
var G__19763 = cljs.core.rest.call(null,path);
obj = G__19762;
path = G__19763;
continue;
} else {
...
return (function (accum,p__19764){
var vec__19765 = p__19764;
var bit = cljs.core.nth.call(null,vec__19765,(0),null);
var protocol = cljs.core.nth.call(null,vec__19765,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__19768){
var vec__19769 = p__19768;
var ns = cljs.core.nth.call(null,vec__19769,(0),null);
var name = cljs.core.nth.call(null,vec__19769,(1),null);
var selector = cljs.core.nth.call(null,vec__19769,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__19774,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__19774,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__19774,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__19772_SHARP_){
return (obj[cljs.core.first.call(null,p1__19772_SHARP_)]);
});})(name,sorted_matches,vec__19774,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
