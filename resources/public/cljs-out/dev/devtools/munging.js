...
var o19664 = temp__5455__auto__;
var temp__5455__auto____$1 = (o19664["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o19665 = temp__5455__auto____$1;
return (o19665["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__19484__auto__ = f;
return (o__19484__auto__["toString"]).call(o__19484__auto__);
} else {
return "";
}
}catch (e19666){var _ = e19666;
return "";
}});
...
try{var o__19484__auto___19668 = t;
(o__19484__auto___19668["cljs$lang$ctorPrWriter"]).call(o__19484__auto___19668,t,writer);
}catch (e19667){var __19669 = e19667;
}
...
var char_code = (function (){var o__19484__auto__ = (new String(char$));
return (o__19484__auto__["charCodeAt"]).call(o__19484__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__19484__auto__ = String;
return (o__19484__auto__["fromCharCode"]).call(o__19484__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__19670 = num_code;
switch (G__19670) {
case (1):
return (185);
...
var o__19484__auto__ = String;
return (o__19484__auto__["fromCharCode"]).call(o__19484__auto__,superscript_code);
});
/**
...
}catch (e19672){var _e__19491__auto__ = e19672;
return false;
}})())){
...
var vec__19673 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__19673,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o19676 = temp__5455__auto__;
var temp__5455__auto____$1 = (o19676["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o19677 = temp__5455__auto____$1;
return (o19677["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4531__auto___19684 = arguments.length;
var i__4532__auto___19685 = (0);
while(true){
if((i__4532__auto___19685 < len__4531__auto___19684)){
args__4534__auto__.push((arguments[i__4532__auto___19685]));

var G__19686 = (i__4532__auto___19685 + (1));
i__4532__auto___19685 = G__19686;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__19680){
var vec__19681 = p__19680;
var ns_detector = cljs.core.nth.call(null,vec__19681,(0),null);
...
var G__19687 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__19688 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__19687;
remaining_tokens = G__19688;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq19678){
var G__19679 = cljs.core.first.call(null,seq19678);
var seq19678__$1 = cljs.core.next.call(null,seq19678);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__19679,seq19678__$1);
});
...
var vec__19692 = cljs.core.split_with.call(null,(function (p1__19691_SHARP_){
return cljs.core.not_EQ_.call(null,p1__19691_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__19692,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__19692,(1),null);
...
var vec__19695 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__19695,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__19695,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__19698 = cljs.core.rest.call(null,remaining_tokens);
var G__19699 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__19698;
name_tokens = G__19699;
continue;
} else {
...
var vec__19702 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__19702,(0),null);
var arity = cljs.core.nth.call(null,vec__19702,(1),null);
var vec__19705 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__19705,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__19705,(1),null);
var vec__19708 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__19708,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__19708,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__19708,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__19708,(3),null);
...
var vec__19714 = result;
var munged_ns = cljs.core.nth.call(null,vec__19714,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__19714,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__19714,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__19714,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__19714,(4),null);
var arity = cljs.core.nth.call(null,vec__19714,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__19718 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__19718,(0),null);
var args = cljs.core.nth.call(null,vec__19718,(1),null);
var vec__19721 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__19721,(0),null);
var name = cljs.core.nth.call(null,vec__19721,(1),null);
...
var G__19724 = (arity + (1));
var G__19725 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__19726){
var vec__19727 = p__19726;
var arity = cljs.core.nth.call(null,vec__19727,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__19727,(1),null);
...
return cljs.core.get.call(null,arities,p1__19730_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__19731_SHARP_);
...
var args__4534__auto__ = [];
var len__4531__auto___19738 = arguments.length;
var i__4532__auto___19739 = (0);
while(true){
if((i__4532__auto___19739 < len__4531__auto___19738)){
args__4534__auto__.push((arguments[i__4532__auto___19739]));

var G__19740 = (i__4532__auto___19739 + (1));
i__4532__auto___19739 = G__19740;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__19734){
var vec__19735 = p__19734;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__19735,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq19732){
var G__19733 = cljs.core.first.call(null,seq19732);
var seq19732__$1 = cljs.core.next.call(null,seq19732);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__19733,seq19732__$1);
});
...
var G__19741 = arg;
var G__19741__$1 = (((G__19741 instanceof cljs.core.Keyword))?G__19741.fqn:null);
switch (G__19741__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__19743__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__19743__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__19743__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__19743__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__19744 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__19744,(0),null);
var fn_name = cljs.core.nth.call(null,vec__19744,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__19744,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__19744,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__19744,(4),null);
var arity = cljs.core.nth.call(null,vec__19744,(5),null);
...
var o__19484__auto__ = f;
return (o__19484__auto__["getBasis"]).call(o__19484__auto__);
});
/**
...
}catch (e19748){var _e__19491__auto__ = e19748;
...
var G__19749 = (obj[cljs.core.first.call(null,path)]);
var G__19750 = cljs.core.rest.call(null,path);
obj = G__19749;
path = G__19750;
continue;
} else {
...
return (function (accum,p__19751){
var vec__19752 = p__19751;
var bit = cljs.core.nth.call(null,vec__19752,(0),null);
var protocol = cljs.core.nth.call(null,vec__19752,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__19755){
var vec__19756 = p__19755;
var ns = cljs.core.nth.call(null,vec__19756,(0),null);
var name = cljs.core.nth.call(null,vec__19756,(1),null);
var selector = cljs.core.nth.call(null,vec__19756,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__19761,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__19761,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__19761,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__19759_SHARP_){
return (obj[cljs.core.first.call(null,p1__19759_SHARP_)]);
});})(name,sorted_matches,vec__19761,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
