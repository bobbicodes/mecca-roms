...
}catch (e24590){var _e = e24590;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___24593 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5455__auto___24593)){
var seen_errors_24594 = temp__5455__auto___24593;
if(cljs.core.truth_(seen_errors_24594.has(self))){
} else {
seen_errors_24594.add(self);

var temp__5457__auto___24595 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5457__auto___24595)){
var sense_24596 = temp__5457__auto___24595;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_24596)].join('');
} else {
}
}
} else {
