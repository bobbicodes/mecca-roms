...
}catch (e24592){var _e = e24592;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___24595 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5455__auto___24595)){
var seen_errors_24596 = temp__5455__auto___24595;
if(cljs.core.truth_(seen_errors_24596.has(self))){
} else {
seen_errors_24596.add(self);

var temp__5457__auto___24597 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5457__auto___24597)){
var sense_24598 = temp__5457__auto___24597;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_24598)].join('');
} else {
}
}
} else {
