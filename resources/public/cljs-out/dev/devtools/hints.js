...
var map__24565 = top_item;
var map__24565__$1 = ((((!((map__24565 == null)))?(((((map__24565.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__24565.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__24565):map__24565);
...
}catch (e24564){var _e = e24564;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___24567 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5455__auto___24567)){
var seen_errors_24568 = temp__5455__auto___24567;
if(cljs.core.truth_(seen_errors_24568.has(self))){
} else {
seen_errors_24568.add(self);

var temp__5457__auto___24569 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5457__auto___24569)){
var sense_24570 = temp__5457__auto___24569;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_24570)].join('');
} else {
}
}
} else {
